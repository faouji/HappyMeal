    ...
    <div id="food-menu" class="light-wrapper">
        ...
        <div class="container inner">
            ...
            <p class="lead main text-center">Allez depechez vous!</p>
                        ...
                        <div class="row">
                <div class="container">
  <h2>Menu de jour '#OFFRES SPÉCIALES!'</h2>  
  
     
   <div class="row">
    <div class="col-sm-3 col-md-3">
                      <div class="menu-images "><a  href="../img/dish/dish20.jpg"><img src="../img/dish/dish20.jpg" ></a></div>
                        </div>   
                          <div class="col-sm-3 col-md-3">
                      <div class="menu-images "> <a  href="../img/dish/2.jpg"><img src="../img/dish/2.jpg" >
                      </a></div>
                        </div>   <div class="col-sm-3 col-md-3">
                      <div class="menu-images "><a  href="../img/dish/3.jpg"><img src="../img/dish/3.jpg" >
                      </a></div>
                        </div>      
    ...
    <tbody>
      <?php 
        ...
        echo "<td>".$value['n_table']."</td>"?>
             ...
             <center>   <form class="form form-table" method="post" name="" action="../controller/conj.php">
               <div class="row">
                          <div class="">
                       <button type="submit" class="btn btn-danger btn-lg" name ="toto">Affecter!</button>
                          </div>
                        </div>
                      </form></center>
</div>
